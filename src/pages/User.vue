...
export default {
  ...
  data() {
    return {
      cellLists1: [
        {
          link: "",
          icon: require('../assets/images/user-cert.png'),
          text: "学生认证",
          desc: "",
          badg: "",
          more: true
        ...
        {
          link: "user/info",
          icon: require('../assets/images/user-detail.png'),
          text: "我的详情",
          desc: "",
          badg: "",
          more: true
        ...
        // {
        //   link: "user/msg",
        //   iconUrl: require('../assets/images/user-message.png'),
        //   text: "消息通知",
        //   desc: "",
        //   badg: "4",
        //   more: true
      ...
      cellLists2: [
        {
          link: "",
          icon: require('../assets/images/user-addfriend.png'),
          text: "邀请好友",
          desc: "",
          badg: "",
          more: true
        ...
        {
          link: "",
          icon: require('../assets/images/user-school.png'),
          text: "选择高校",
          desc: "",
          badg: "",
          more: true
      ...
      cellLists3: [
        {
          link: "user/set",
          icon: require('../assets/images/user-set.png'),
          text: "设置",
          desc: "",
          badg: "",
          more: true
        ...
        {
          link: "",
          icon: require('../assets/images/user-call.png'),
          text: "联系客服",
          desc: "18679168426",
          badg: "",
          more: true
  ...
  created() {
    if (this.loginStatus) {
      api.getPubTotravelNum(this.userInfo.objectId).then(res => {
